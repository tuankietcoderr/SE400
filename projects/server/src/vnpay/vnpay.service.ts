...
export class VnpayService {
   ...
   */
  async verifyReturnUrl(data: ReturnQueryFromVNPay, options?: VerifyReturnUrlOptions): Promise<VerifyReturnUrl> {
   ...
   */
  async verifyIpnCall(data: ReturnQueryFromVNPay, options?: VerifyIpnCallOptions): Promise<VerifyIpnCall> {
